...
def populate( request, profile=None ):
    """
    @param profile:     the name of the profile folder that contains the 
                        base file of the population. These files can either
                        be composed manually or generated by 'generate'
